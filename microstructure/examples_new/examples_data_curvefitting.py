...
f = open('U:/01_Ravi_Phanindra/mpaut/examples_new/Airfox_Output_completed/results_Airfox_ZrO2_step10_nrves_3.txt') 
data = f.read()
...
# ax1.plot(rve_dim, Youngs_modulus_Hill)
# ax1.plot(rve_dim, Youngs_modulus_Reuss)
# ax1.plot(rve_dim, Youngs_modulus_voigt)
# ax1.set_xlabel('Dimensions of RVEs introduced')
# ax2.plot(ZrO2, np.ones(100)) # Create a dummy plot
# ax2.set_xlabel('Volume fraction of ZrO2 in %')
# plt.show()

# plt.scatter(rve_dim, Youngs_modulus_Hill)
# plt.scatter(rve_dim, Youngs_modulus_Reuss)
# plt.scatter(rve_dim, Youngs_modulus_voigt)
# plt.xlabel('Dimensions of RVEs introduced')

# plt.scatter(no_rves, Youngs_modulus_Hill)
# plt.scatter(no_rves, Youngs_modulus_Reuss)
# plt.scatter(no_rves, Youngs_modulus_voigt)
# plt.xlabel('Number of RVEs introduced')

# plt.scatter(Number_of_objects, Youngs_modulus_Hill)
# plt.scatter(Number_of_objects, Youngs_modulus_Reuss)
# plt.scatter(Number_of_objects, Youngs_modulus_voigt)
# plt.xlabel('Number of Objects introduced')
...
# plt.scatter(Pores, Youngs_modulus_Hill)
# plt.scatter(Pores, Youngs_modulus_Reuss)
# plt.scatter(Pores, Youngs_modulus_voigt)
# plt.xlabel('Volume fraction of Porosity in %')
...
# plt.scatter(rve_dim, Shear_modulus_Hill)
# plt.scatter(rve_dim, Shear_modulus_Reuss)
# plt.scatter(rve_dim, Shear_modulus_voigt)
# plt.xlabel('Dimensions of RVEs introduced')
...
# plt.scatter(no_rves, Shear_modulus_Hill)
# plt.scatter(no_rves, Shear_modulus_Reuss)
# plt.scatter(no_rves, Shear_modulus_voigt)
# plt.xlabel('Number of RVEs introduced')


# plt.scatter(Number_of_objects, Shear_modulus_Hill)
# plt.scatter(Number_of_objects, Shear_modulus_Reuss)
# plt.scatter(Number_of_objects, Shear_modulus_voigt)
# plt.xlabel('Number of Objects introduced')

           
# plt.scatter(Pores, Shear_modulus_Hill)
# plt.scatter(Pores, Shear_modulus_Reuss)
# plt.scatter(Pores, Shear_modulus_voigt)
# plt.xlabel('Volume fraction of Porosity in %')
...
# plt.scatter(rve_dim, Bulk_modulus_Hill)
# plt.scatter(rve_dim, Bulk_modulus_Reuss)
# plt.scatter(rve_dim, Bulk_modulus_voigt)
# plt.xlabel('Dimensions of RVEs introduced')
...
# plt.scatter(Number_of_objects, Bulk_modulus_Hill)
# plt.scatter(Number_of_objects, Bulk_modulus_Reuss)
# plt.scatter(Number_of_objects, Bulk_modulus_voigt)
# plt.xlabel('Number of Objects introduced')

# plt.scatter(no_rves, Bulk_modulus_Hill)
# plt.scatter(no_rves, Bulk_modulus_Reuss)
# plt.scatter(no_rves, Bulk_modulus_voigt)
# plt.xlabel('Number of RVEs introduced')

# plt.scatter(Pores, Bulk_modulus_Hill)
# plt.scatter(Pores, Bulk_modulus_Reuss)
# plt.scatter(Pores, Bulk_modulus_voigt)
# plt.xlabel('Volume fraction of Porosity in %')
...
# plt.scatter(rve_dim, Poissons_ratio_Hill)
# plt.scatter(rve_dim, Poissons_ratio_Reuss)
# plt.scatter(rve_dim, Poissons_ratio_voigt)
# plt.xlabel('Dimensions of RVEs introduced')
...
# plt.scatter(Number_of_objects, Poissons_ratio_Hill)
# plt.scatter(Number_of_objects, Poissons_ratio_Reuss)
# plt.scatter(Number_of_objects, Poissons_ratio_voigt)
# plt.xlabel('Number of Objects introduced')

# plt.scatter(no_rves, Poissons_ratio_Hill)
# plt.scatter(no_rves, Poissons_ratio_Reuss)
# plt.scatter(no_rves, Poissons_ratio_voigt)
# plt.xlabel('Number of RVEs introduced')

# plt.scatter(Pores, Poissons_ratio_Hill)
# plt.scatter(Pores, Poissons_ratio_Reuss)
# plt.scatter(Pores, Poissons_ratio_voigt)
# plt.xlabel('Volume fraction of Porosity in %')
