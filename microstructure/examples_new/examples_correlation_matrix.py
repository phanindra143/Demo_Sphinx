...
# path_for_chordlength= "U:/01_Ravi_Phanindra/mpaut/examples_new/Airfox_Output_completed/Airfox_step_5_nobj_80_rvedim_32"
# scan_folder(path_for_chordlength)  # Insert parent direcotry's path

#-----------------------------------------------------------------------------

path_for_results = 'U:/01_Ravi_Phanindra/mpaut/examples_new/Airfox_Output_completed/Airfox_ZrO2_step10_nrves_3/results_Airfox_ZrO2_step10_nrves_3.txt'
...
# # No need to use this function for choed length analysis data handling
...
#                     # print(file_name)
#                     # f = open(current_path2)
#                     # data = f.read()
#                     # print(data)
#                     data_function(current_path2) # calling of the data_function
...
def results(path):
        ...
        for key in dic1 :   
            ...
            #------------------------------------------------------------------
            replace_path = folder_path.replace("\\", "/")
...
data1 = {'Pore_ZrO2': interface_fractions_Pore_ZrO2,
        ...
        'ZrO2_Al2O3' : interface_fractions_ZrO2_Al2O3,
        'Al2O3_Al2O3' : interface_fractions_Al2O3_Al2O3,
        'Youngs_modulus_Reuss' : Youngs_modulus_Reuss,
        'Shear_modulus_Reuss' : Shear_modulus_Reuss,
        'Bulk_modulus_Reuss' : Bulk_modulus_Reuss,
        'Poissons_ratio_Reuss' :  Poissons_ratio_Reuss
        }
...
data1 = {'Pore_ZrO2': interface_fractions_Pore_ZrO2,
        ...
        'ZrO2_Al2O3' : interface_fractions_ZrO2_Al2O3,
        'Al2O3_Al2O3' : interface_fractions_Al2O3_Al2O3,
        'Youngs_modulus_voigt' : Youngs_modulus_voigt,
        'Shear_modulus_voigt' : Shear_modulus_voigt,
        'Bulk_modulus_voigt' : Bulk_modulus_voigt,
        'Poissons_ratio_voigt' :  Poissons_ratio_voigt
        }
...
df = pd.DataFrame(data_VF1,columns=['Vol_Frac_of_ZrO2', 'Vol_Frac_of_Al2O3', 'Vol_Frac_of_Pores',
                        'Youngs_modulus_Reuss', 'Shear_modulus_Reuss', 'Bulk_modulus_Reuss','Poissons_ratio_Reuss'])

corrMatrix = df.corr()
sn.heatmap(corrMatrix, annot=True).set_title('Correlation matrix of Reuss Properties with Volume Fractions of constituents')
plt.show()
...
df = pd.DataFrame(data_VF2,columns=['Vol_Frac_of_ZrO2', 'Vol_Frac_of_Al2O3', 'Vol_Frac_of_Pores',
                        'Youngs_modulus_voigt', 'Shear_modulus_voigt', 'Bulk_modulus_voigt','Poissons_ratio_voigt'])

corrMatrix = df.corr()
sn.heatmap(corrMatrix, annot=True).set_title('Correlation matrix of Voigt Properties with Volume Fractions of constituents')
plt.show()
